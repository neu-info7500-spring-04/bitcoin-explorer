    ...
    <div>
      <input
        ...
        style={{
          color: "black",
          marginRight: "10px",
          borderColor: isValidAddress ? "initial" : "red",
        }} // Change text color to black and add right margin, highlight with red if address is invalid
      />
      {!isValidAddress && (
        <div style={{ color: "red" }}>Enter a valid Bitcoin address</div>
      )}
      <button
